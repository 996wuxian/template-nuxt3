...
.switch label .bulb {
  ...
  transition: 0.7s;
  box-shadow:
    inset 0 0 1px 1px #13428e,
    inset 0 0 2px 3px #13428e,
    0 6px 9px -3px rgba(0, 0, 0, 0.4);
}
.switch label .bulb .bulb-center {
  ...
  box-shadow: inset 0 0 0 1px #13428e;
}
